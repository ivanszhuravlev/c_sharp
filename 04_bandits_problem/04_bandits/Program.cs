...
** прострелить несколько банок. В ответ Ларри сказал, что Гарри должен ему еще больше денег по тем же причинам. 
...
namespace _04_bandits
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int garry = int.Parse(Str[0]) - 1,
                larry = int.Parse(Str[1]) - 1;

            Console.WriteLine(larry + " " + garry);
